package uk.co.netbuilder.academy.aem6.core.utils;
...
public class Utils {
	...
	public static final String GCFINDERPAGE_PATH = "/content/netbuilderacademy/en/staff/gc-finder";
	
	public static final String PUBLISH_RUNMODE = "dispatcher";
	
	public static final String NB_DESIGN_PATH = "/etc/designs/netbuilderacademy";
	
	public static final String GC_PAGE_RENDERER_PATH = "netbuilderacademy/components/pages/people/gc-page";
	public static final String GC_TEMPLATE_PATH = "/apps/netbuilderacademy/templates/gc-page";
